...
cities = {
    'atlanta': {'country': 'usa', 'population': 'a lot', 'fact': "it's hot in atlanta"},
    'madrid': {'country': 'europe', 'population': 'a hella lot', 'fact': "it has a renowned soccer team"}, 
    'japan': {'country': 'asia', 'population': 'a lot for smaller country', 'fact': "it's home to the sony headquarters"}
}
