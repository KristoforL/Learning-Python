...
fav_places = {
    'christian': ['japan', 'china', 'new york'], 
    'corey':['new york','jamaica','uk'], 
    'kelli':['california', 'spain'], 
    'toni':['shanghai', 'colorado'], 
    }
...
for person, places in fav_places.items():
    ...
    for place in places:
        print(f"{place.title()}")
    #Just so there is space between each list of places the persons fav places
    print()