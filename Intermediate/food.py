...
#If you do the equal sign instead of the copy method this will set the second list equal to the first list so everything you change in the first list will also be in the second list instead of just copying the content of the original list
my_food = ['pizza', 'falafel', 'carrot cake']
friend_food = my_food

print("\nWe are setting the list equal to each other now and my favorite foods are: ")
print(my_food)
...
#You can have a third parameter that will skip between items in your range
