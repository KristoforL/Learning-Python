...
#This is a block of code that can be called any where in this code or even in anothere code
def greet_user():
...
#This is the same block of code and as you can see it has a arguement in it that now take a name in and uses it in the return
def greet_user(username):
    """Display a simple greeting."""
    print(f"Hello {username.title()}")

#We put in a string in the arguement and the return is greeting the user
greet_user('JQ')
...
#This is an empy list to add names to and a indicator to tell weather to continue later
users = []
asking = True
...
while asking:
    ...
    if your_name.lower() != 'done':
        #Appends entrys to empty list for later and greets indivdual user
