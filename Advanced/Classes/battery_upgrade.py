class Car:
    """This will model what making car is like"""
    ...
    def __init__(self, make, model, year):
        ...
        self.model = model
        self.year = year
        #This sets a default value to the mileage and is not included in the arguments
    ...
    def fill_gas_tank(self):
        """This will simulate the gas tank is full"""
...
class Battery:
    ...
    def upgrade_battery(self):
        ...
        if self.battery_size != 100:
            #Remember that that one '=' is to assign and two is to compare
